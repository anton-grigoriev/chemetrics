		...
		<div class="row">
			<div class="col-md-7">
				...
				<table class="table table-condensed table-hover">
					<tr>
						<td width="50%">Встроенные программы</td>
						<td>более 50</td>
					</tr>
					<tr>
						<td>Длина волны (нм)</td>
						<td>420, 520, 580, 610</td>
					</tr>
					<tr>
						<td>Точность длины волны</td>
						<td>&plusmn;2 нм</td>
						</tr>
					<tr>
						<td>Выбор длины волны</td>
						<td>Автоматический</td>
					</tr>
					<tr>
						<td>Фотометрический диапазон</td>
						<td>0&mdash;2А</td>
					</tr>
					<tr>
					...
					<tr>
						<td>Измерительный элемент</td>
						<td>Фотодиод</td>
					</tr>
					<tr>
						<td>Ширина спектра</td>
						<td>10&plusmn;2 нм</td>
					</tr>
					<tr>
						<td>Рабочая температура</td>
						<td>0&mdash;45&deg;С</td>
					</tr>
					<tr>
						<td>Влажность</td>
						<td>90% при 50<sup>о</sup>С max</td>
					</tr>

					<tr>
						<td>Адаптеры кювет</td>
						<td>16 мм, 13 мм</td>
					</tr>
					<tr>
						<td>Единицы</td>
						<td>мг/л, ppm, мкг/л, ppb, г/л, оптическая плотность или % пропускания</td>
					</tr>
					<tr>
						<td>Регистрация данных</td>
						<td>100 данных, дата и время</td>
					</tr>
					<tr>
						<td>Соответствие</td>
						<td>European CE Mark</td>
					</tr>
					<tr>
						<td>Программные методы</td>
						<td>190 и 10 пользовательских</td>
					</tr>
				</table>
			</div>
			<div class="col-md-5">
		...
		<div class="row">
			...
			<h2>Технические характеристики</h2>
				<table class="table table-condensed table-hover">
					<tr>
						<td>Источник света</td>
						<td>светодиод / интерференционный фильтр</td>
					</tr>
					<tr>
						<td>Оптический путь</td>
						<td>13 мм / 16 мм/ 24 мм</td>
					</tr>
					<tr>
			...
			<h2>Определяемые вещества</h2>
				<table class="table table-condensed table-hover">
					...
					<tr>
						<td><a href="/analytes.php?id=oxygen">Кислород</a></td><td>I-2002</td><td>2,0&mdash;15,0</td><td>K-7513</td>
					</tr>
					<tr>
						<td><a href="/analytes.php?id=detergents">Моющие средства</a></td><td>I-2017</td><td>0,25&mdash;2,50</td><td>R-9423</td>
					</tr>
					<tr>
						<td><a href="/analytes.php?id=ozone">Озон</a></td><td>I-2019</td><td>0,20&mdash;5,00</td><td>K-7423</td>
					</tr>
					<tr>
						<td><a href="/analytes.php?id=peracetic">Перуксусная кислота</a></td><td>I-2020</td><td>0,40&mdash;5,00</td><td>K-7913</td>
					</tr>
					<tr>
						<td><a href="/analytes.php?id=chlorine">Хлор</a></td><td>I-2001</td><td>0,40&mdash;5,00</td><td>K-2513</td>
					</tr>
					<tr>
						<td><a href="/analytes.php?id=chlorinedioxide">Хлора диоксид</a></td><td>I-2005</td><td>1,0&mdash;11,0</td><td>K-2703</td>
					</tr>
				</table>
			</div>
			<div class="col-md-5">
